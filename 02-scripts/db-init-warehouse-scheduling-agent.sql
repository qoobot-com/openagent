...
-- 创建数据库
-- ============================================
DROP DATABASE IF EXISTS openagent_warehouse_scheduling_agent;
CREATE DATABASE openagent_warehouse_scheduling_agent
    ENCODING 'UTF8'
    LC_COLLATE = 'en_US.UTF-8'
    LC_CTYPE = 'en_US.UTF-8'
    TEMPLATE template0;

\c openagent_warehouse_scheduling_agent
