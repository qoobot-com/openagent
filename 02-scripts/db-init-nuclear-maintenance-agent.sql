...
-- 创建数据库
-- ============================================
DROP DATABASE IF EXISTS openagent_nuclear_maintenance_agent;
CREATE DATABASE openagent_nuclear_maintenance_agent
    ENCODING 'UTF8'
    LC_COLLATE = 'en_US.UTF-8'
    LC_CTYPE = 'en_US.UTF-8'
    TEMPLATE template0;

\c openagent_nuclear_maintenance_agent
