...
| 服务 | 地址 |
|------|------|
| Swagger UI | http://localhost:8001/drug-research-agent/swagger-ui.html |
| 健康检查 | http://localhost:8001/drug-research-agent/actuator/health |
| Actuator | http://localhost:8001/drug-research-agent/actuator |
...
|------|-------|------|------|--------|------|
| 1 | drug-research-agent | 8001 | /drug-research-agent | openagent_drug_research_agent | 药物研发协同 |
| 2 | medical-diagnosis-agent | 8002 | /medical-diagnosis-agent | openagent_medical_diagnosis_agent | 智能医疗诊断 |
| 3 | medical-device-agent | 8003 | /medical-device-agent | openagent_medical_device_agent | 医疗设备协同 |
| 4 | agricultural-pest-agent | 8004 | /agricultural-pest-agent | openagent_agricultural_pest_agent | 农业病虫害预测 |
| 5 | cross-border-logistics-agent | 8005 | /cross-border-logistics-agent | openagent_cross_border_logistics_agent | 跨境物流优化 |
| 6 | nuclear-maintenance-agent | 8006 | /nuclear-maintenance-agent | openagent_nuclear_maintenance_agent | 核电设备预测性维护 |
| 7 | power-grid-agent | 8007 | /power-grid-agent | openagent_power_grid_agent | 电网负荷预测 |
| 8 | semiconductor-optimization-agent | 8008 | /semiconductor-optimization-agent | openagent_semiconductor_optimization_agent | 半导体工艺优化 |
| 9 | financial-pricing-agent | 8009 | /financial-pricing-agent | openagent_financial_pricing_agent | 金融动态定价 |
| 10 | warehouse-scheduling-agent | 8010 | /warehouse-scheduling-agent | openagent_warehouse_scheduling_agent | 智能仓储调度 |
| 11 | construction-safety-agent | 8011 | /construction-safety-agent | openagent_construction_safety_agent | 建筑安全巡检 |
| 12 | supply-chain-agent | 8012 | /supply-chain-agent | openagent_supply_chain_agent | 供应链韧性 |
| 13 | customer-service-agent | 8013 | /customer-service-agent | openagent_customer_service_agent | 智能客服 |
| 14 | industrial-quality-agent | 8014 | /industrial-quality-agent | openagent_industrial_quality_agent | 工业质检 |
| 15 | intelligent-traffic-agent | 8015 | /intelligent-traffic-agent | openagent_intelligent_traffic_agent | 智能交通管理 |
| 16 | marketing-planning-agent | 8016 | /marketing-planning-agent | openagent_marketing_planning_agent | 智能营销策划 |
| 17 | intelligent-ops-agent | 8017 | /intelligent-ops-agent | openagent_intelligent_ops_agent | 智能运维管理 |
| 18 | investment-advisor-agent | 8018 | /investment-advisor-agent | openagent_investment_advisor_agent | 智能投资顾问 |
| 19 | power-trading-agent | 8019 | /power-trading-agent | openagent_power_trading_agent | 智能电力交易 |
...
| [垂直领域AI Agent商业设计](01-docs/垂直领域AI%Agent商业设计.md) | 商业设计与场景分析 |
